/*
     ...
     The fundamental truths of The Laws of Form are:

     There are distinctions that are continent, they are persistent outside of time.
       * An observer/actor is required to both observe or indicate the form of the distinction.
       * There can be no indication without intention, i.e. there are no accidents, just unknown observers/actors.
       * When things change it happens in discrete steps. Any step can be further distinguished into as small and numerous steps as necessary for them to be followed by another observer/actor, until one gets to a single distinction.
       * A string of steps becomes a calculation or procedure for doing something intended by the actor and observed by the observer.

     Here a simple solver for basic two axioms low of form:
    ...
    REF:
    https://groups.io/g/lawsofform/message/1593
    https://docs.google.com/document/d/1oYiiLo3GGRqvyApzKWQC7KdFufLoI2JKzfFbXNWNqD0/edit?usp=sharing
*/
